...
namespace QLPM.Controllers
{
    ...
    public class TRANGTHAIController : ControllerBase
    {
        ...
        // GET: api/TRANGTHAI/5
        [HttpGet("{id}")]
        public async Task<IActionResult> GetTRANGTHAI([FromRoute] string id)
        {
        ...
        // PUT: api/TRANGTHAI/5
        [HttpPut("{id}")]
        public async Task<IActionResult> PutTRANGTHAI([FromRoute] string id, [FromBody] TRANGTHAI tRANGTHAI)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteTRANGTHAI([FromRoute] string id)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        private bool TRANGTHAIExists(string id)
        {
